...
export class UpdateQuotationItemPrecision1778249885003 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "audits" DROP CONSTRAINT "audits_conferido_por_id_fkey"`);
        await queryRunner.query(`ALTER TABLE "audits" DROP CONSTRAINT "audits_quotation_id_fkey"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."idx_audits_created_at"`);
        ...
        await queryRunner.query(`ALTER TABLE "products" DROP CONSTRAINT "UQ_products_nome"`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."audits_status_enum" AS ENUM('OK', 'DIVERGENTE', 'CONFERIDO')`);
