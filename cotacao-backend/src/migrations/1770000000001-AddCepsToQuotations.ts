...
export class AddCepsToQuotations1770000000001 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "quotations" ADD COLUMN IF NOT EXISTS "origem_cep" character varying(10)`);
        await queryRunner.query(`ALTER TABLE "quotations" ADD COLUMN IF NOT EXISTS "destino_cep" character varying(10)`);
    }
