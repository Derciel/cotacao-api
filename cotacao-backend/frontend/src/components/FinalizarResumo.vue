...
<style scoped>
.loading-state { text-align: center; padding: 100px; color: var(--text-muted); font-style: italic; }
...
.card-header { background: var(--primary-dark); color: white; padding: 15px 25px; font-weight: 700; font-size: 0.9rem; text-transform: uppercase; letter-spacing: 1px; }
...
.shipping-box { background: var(--bg-input); border: 1px solid var(--border); border-radius: 12px; padding: 25px; margin-bottom: 30px; }
.shipping-header { font-size: 0.75rem; font-weight: 800; color: var(--text-muted); margin-bottom: 10px; letter-spacing: 1px; }
.price-tag { margin-bottom: 20px; }
.price-tag small { color: var(--text-muted); font-size: 0.8rem; font-weight: 600; }
.price-tag .value { font-size: 2.5rem; font-weight: 900; color: var(--text-main); line-height: 1; margin-top: 5px; }
...
th { text-align: left; padding: 15px 20px; background: var(--bg-input); color: var(--text-muted); border-bottom: 2px solid var(--border); font-size: 0.7rem; text-transform: uppercase; font-weight: 800; }
...
.status-pill { background: var(--status-aprovado-bg); color: var(--status-aprovado-text); padding: 4px 10px; border-radius: 99px; font-weight: 800; font-size: 0.65rem; text-transform: uppercase; }
