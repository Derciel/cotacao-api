...
.rec-text { font-size: 0.95rem; color: var(--text-muted); line-height: 1.5; }
.rec-text strong { color: var(--text-main); }
...
.box-header h3 { font-size: 1.1rem; font-weight: 800; color: var(--text-main); margin: 0; display: flex; align-items: center; gap: 10px; }
...
.m-name { font-weight: 800; color: var(--text-main); font-size: 0.9rem; }
.m-count { font-size: 0.75rem; color: var(--text-muted); font-weight: 700; background: var(--bg-surface); padding: 2px 8px; border-radius: 6px; }

.m-value { font-size: 1.4rem; font-weight: 900; color: var(--text-main); margin-bottom: 12px; }

.m-progress-bg { height: 6px; background: var(--bg-surface); border-radius: 10px; overflow: hidden; }
